...
import { CalendarDays, IdCard, MapPin, TicketIcon } from "lucide-react";
...
function Ticket({ ticketId }: { ticketId: Id<"tickets"> }) {
  ...
  return (
    <div
      className={`bg-white rounded-xl overflow-hidden shadow-xl border ${ticket.event.is_cancelled ? "border-red-300" : "border-gray-200"}`}
    >
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center text-gray-600">
              <CalendarDays
                className={`w-5 h-5 mr-3 ${ticket.event.is_cancelled ? "text-red-500" : "text-blue-500"}`}
              />
              <div>
          ...
          <div className="flex flex-col items-center justify-center border-l border-gray-200 pl-6">
            ...
            <p className="mt-2 text-sm text-gray-500 breal-all text-center max-w-[200px] md:max-w-full">
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          ...
          {ticket.event.is_cancelled ? (
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              ...
              <li>
                * Age restrictions may apply. Please check the event details.
              </li>
            </ul>
          )}
        </div>
